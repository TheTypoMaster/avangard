...
<h3 align="center" style="color: #000000; padding: 2px; margin: 2px; font-size: 14px;">
	...
	if($ar_res = $res->GetNext()) {  
		$name_cur_salon = $ar_res['NAME'];
		echo '<a style=" font-size: 14px; color: #000000;" href="/redesign/where_buy/detail.php?id='.$s_val.'">'.$name_cur_salon.'</a>';
		}
		}
	?>
	&nbsp;&nbsp;&nbsp;
...
$collections[42]="LeRoi";
$collections[45]="День и Ночь";
$collections[2761]="кроватей";
$collections[5757]="корпусной мебели";
...
echo '<br><br>';
echo '<H1 style="color: rgb(102, 102, 102);">Салон:<br><a style="font-size: 16px; color: #000000;" href="/redesign/where_buy/detail.php?id='.$s_val.'">'.$name_cur_salon.'</a></H1><br><br>';
...
opacity: 0.5; /* CSS3 - Mozilla 1.7b +, Firefox 0.9 +, Safari 1.2+, Opera 9 */ " alt="Товар продан" src="/images/sold.gif">';
	...
	$html_temp .='" border="0" width="200" height="100"></a><div class="highslide-caption">'.$arFields['PREVIEW_TEXT'].'</div></td></tr>
		...
		$html_temp .='>';
		if($arFields["PROPERTY_PRICE_NEW_VALUE"] && ($id=="343" or $id=="566" or $id=="2635" or $id=="4559" or $id=="328" or $id=="330" or $id=="339" or $id=="5242" or $id=="5360" or $id=="1483" or $id=="402")) $html_temp .= $arFields["PROPERTY_PRICE_NEW_VALUE"].' р.';
		$html_temp .='</td></tr>
			...
			$html_temp .='>';
			if($arFields["PROPERTY_PRICE_OLD_VALUE"] && ($id=="343" or $id=="566" or $id=="2635" or $id=="4559" or $id=="328" or $id=="330" or $id=="339" or $id=="5242" or $id=="5360" or $id=="1483" or $id=="402")) $html_temp .= $arFields["PROPERTY_PRICE_OLD_VALUE"].' р.';
			$html_temp .='</td></tr>
	</table>
