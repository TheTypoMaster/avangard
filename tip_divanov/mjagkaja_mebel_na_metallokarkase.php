...
$APPLICATION->SetPageProperty("title", "ћ€гка€ мебель с металлическим каркасом, диваны на металлокаркасе");
$APPLICATION->SetTitle("ћ€гка€ мебель с металлическим каркасом, диваны на металлокаркасе");
