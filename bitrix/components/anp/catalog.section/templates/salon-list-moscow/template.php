...
<?if(!$_REQUEST["SALON_ID"]){?>
	<tr>
		<td colspan="2">
  		...
  		<a href="#" onClick="window.open('/wharetobuy/moscow/map.php','map','directories=no,width=830,height=620,location=no,menubar=no,resizable=yes,scrollbars=yes,status=no,toolbar=no'); return(false);">
