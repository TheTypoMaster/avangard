...
?>
		<div class="photo-edit-field photo-edit-field-image photo-photo" <?
			?>style="width:<?=$arParams["THUMBS_SIZE"]?>px; height:<?=$arParams["THUMBS_SIZE"]?>px; overflow:hidden;display:inline;">
