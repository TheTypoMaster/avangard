...
$count = 0;
	...
	$count++;
	$className = (($count%2) == 1 ? "selected" : "simple");
	?>
	<tr valign="top" class="<?=$className?>">
		<td class="forum-message-user-info" rowspan="2">
			...
			if (is_array($res["AVATAR"]) && (strLen($res["AVATAR"]["HTML"]) > 0)):
				...
				?><a href="<?=$res["profile_view"]?>" title="<?=GetMessage("F_AUTHOR_PROFILE")?>" class="forum-user avatar"><div class="no-avatar"></div></a><?
			endif;
	...
	<tr valign="bottom" class="<?=$className?>">
		<td class="border-top">
			<div class="forum-hr"></div>
			<table class="clear" width="100%">
				<tr valign="top">
			...
			if ($arResult["UserPermission"]>="Q"):
				...
				if ($res["SHOW_STATISTIC"] == "Y"):
					?><?=GetMessage("F_USER_ID")?> <a href="/bitrix/admin/guest_list.php?lang=<?=LANG_ADMIN_LID?>&amp;find_id=<?=$res["GUEST_ID"]?>&amp;set_filter=Y"><?=$res["GUEST_ID"];?></a><br /><?
				endif;
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="forum-message">
	<tr>
		...
		?></div><?
		endforeach;
		?></td></tr><tr><td class="border-top"><div class="forum-hr"></div></td></tr></table><?
?><div class="forum-br"></div><?
endif;
