...
?><table width="100%" class="forum-main forum-stat"><?
...
/*
GetMessage("F_STAT_AT");
GetMessage("F_STAT_MESSAGES");
...
GetMessage("F_STAT_USERS");
GetMessage("F_STAT_USERS_1");
GetMessage("F_STAT_USERS_2_4");
*/
?></table>