...
foreach($arResult as $arComment)
{
	...
	{
		?>
		<a href="<?=$arComment["urlToAuthor"]?>" class="blog-user-grey"></a>&nbsp;<a href="<?=$arComment["urlToBlog"]?>"><?=$arComment["AuthorName"]?></a>
		<?
	}
	...
	*/
	...
	if(strlen($arComment["TitleFormated"]) <= 0) 
	{
		?><br /><small><a href="<?=$arComment["urlToComment"]?>"><?=GetMessage("BLOG_BLOG_MORE")?></a></small><?
	}
	?>
	<br />
	<?
