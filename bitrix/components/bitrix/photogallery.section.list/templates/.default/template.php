...
?>
<style>
div.photo-album-thumbs-list div.photo-item-cover-block-container, 
div.photo-album-thumbs-list div.photo-item-cover-block-outer, 
div.photo-album-thumbs-list div.photo-item-cover-block-inner{
						...
						<div class="photo-item-cover-block-inside"><?
							?><div class="photo-item-cover photo-album-thumbs-avatar <?=(empty($res["DETAIL_PICTURE"]["SRC"])? "photo-album-avatar-empty" : "")?>" <?
								...
								if ($arParams["PERMISSION"] >= "W"):
									...
									?> onclick="window.location='<?=CUtil::JSEscape($res["~LINK"])?>';" <?
								endif;
								?>><?
								if ($arParams["PERMISSION"] >= "W"):
								?><div class="photo-album-menu" onmouseout="this.style.display='none';" <?
									...
									?><div class="photo-album-menu-controls"><?
										?><a rel="nofollow" href="<?=$res["EDIT_LINK"]?>" <?
											...
											?> onclick="jsUtils.PreventDefault(event); EditAlbum('<?=CUtil::JSEscape($res["EDIT_LINK"])?>'); return false;" <?
										...
										?><a rel="nofollow" href="<?=$res["EDIT_ICON_LINK"]?>" <?
											...
											?> onclick="jsUtils.PreventDefault(event); EditAlbum('<?=CUtil::JSEscape($res["EDIT_ICON_LINK"])?>'); return false;" <?
