...
?>
<li class="photo-item photo-gallery-item <?=($res["UF_DEFAULT"] == "Y" ? " photo-gallery-active" : "")?><?
		?><?=(empty($res["CODE"]) ? " photo-item-error" : "")?>" <?
		?> title="<?=($res["UF_DEFAULT"] == "Y" ? GetMessage("P_GALLERY_ACTIVE") : "")?> <?=(empty($res["CODE"]) ? GetMessage("P_ERROR_CODE") : "")?>" >
