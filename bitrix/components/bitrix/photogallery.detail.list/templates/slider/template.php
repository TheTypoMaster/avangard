...
<style>
.photo-slider-container .photo-slider-data-list{position:relative; left:0; white-space: nowrap; overflow:hidden; width:1000%; height:<?=($arParams["THUMBS_SIZE"] + 20)?>px;}
