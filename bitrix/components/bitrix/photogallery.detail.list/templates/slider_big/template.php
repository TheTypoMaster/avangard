												...
												<td class="bxp-mixer-container-player">
													<a href="#" id="bx_slider_nav_play" <?
														?>onclick="if(player){if (player.params['status'] == 'paused') <?
															?>{player.params['status']='play';player.play(); this.title='<?=GetMessage("P_PAUSE_TITLE")?>';} <?
...
oPhotoObjects['min_slider_width'] = <?=$arSlideParams['width']?>;
oPhotoObjects['min_slider_height'] = <?=$arSlideParams['height']?>;
