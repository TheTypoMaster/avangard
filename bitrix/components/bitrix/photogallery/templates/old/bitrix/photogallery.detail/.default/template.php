...
<div class="photo-detail">
	...
	<div class="photo-detail-inner-image">
		...
		<noindex><a rel="nofollow" href="<?=$arResult["SLIDE_SHOW"]?>" title="<?=htmlspecialchars($arResult["ELEMENT"]["~NAME"])?>">
			<div class="photo-photo">
				<div class="photo-img"><?
					?><?=CFile::ShowImage($arResult["ELEMENT"]["PICTURE"]["SRC"], 
						$arParams["THUMBS_SIZE"], 
						$arParams["THUMBS_SIZE"], 
						"border=\"0\" vspace=\"0\" hspace=\"0\" alt=\"".$arResult["ELEMENT"]["CODE"]."\"");?>
				</div>
			</div>
		</a></noindex>
<?
...
<?
	...
	if (!empty($arResult["ELEMENT"]["REAL_PICTURE"]["SRC"])):
			?><noindex><a rel="nofollow" href="http://<?=str_replace("//", "/", $_SERVER['HTTP_HOST']."/".$arResult["ELEMENT"]["REAL_PICTURE"]["SRC"])?>" <?
