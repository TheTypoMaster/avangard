	...
	if(is_array($arItem["ELEMENT"]["PREVIEW_PICTURE"])):
		if($arResult["USER_HAVE_ACCESS"]):
			?><a href="<?=$arItem["ELEMENT"]["URL"]?>"><?
				?><?=CFile::ShowImage($arItem["ELEMENT"]["PREVIEW_PICTURE"]["SRC"], $arParams["THUMBS_SIZE"], $arParams["THUMBS_SIZE"], "border=\"0\" vspace=\"0\" hspace=\"0\" alt=\"".htmlspecialchars($arItem["ELEMENT"]["~CODE"])."\" title=\"".htmlspecialchars($arItem["ELEMENT"]["~NAME"])."\"", "", true);?><?
			?></a><?
		else:
			?><?=CFile::ShowImage($arItem["ELEMENT"]["PREVIEW_PICTURE"]["SRC"], $arParams["THUMBS_SIZE"], $arParams["THUMBS_SIZE"], "border=\"0\" vspace=\"0\" hspace=\"0\" alt=\"".htmlspecialchars($arItem["ELEMENT"]["~CODE"])."\" title=\"".htmlspecialchars($arItem["ELEMENT"]["~NAME"])."\"", "", true);?><?
		endif;
