...
$APPLICATION->SetTitle(GetMessage('REPORT_LIST'));
	...
	<div class="reports-list">
		...
		<table cellspacing="0" class="reports-list-table" id="<?=htmlspecialcharsbx($containerID)?>">
			...
			<tr class="reports-list-item">
				...
				<td  class="reports-date-column reports-last-column"><?=strtolower(FormatDate('j F Y', strtotime($listItem['CREATED_DATE'])))?></td>
			</tr>
			<? endforeach; ?>
		</table>
	</div>
