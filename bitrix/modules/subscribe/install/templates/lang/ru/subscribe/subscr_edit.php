...
$MESS ['adm_module'] = "Модуль недоступен";
$MESS ['adm_module1'] = "Модуль подписки в настоящее время недоступен.";
...
$MESS ['subscr_pass_note'] = "Введите <nobr>e-mail,</nobr> на который вы получаете нашу рассылку, и код подтверждения будет вам выслан на этот адрес.";
