...
<input <?if ($FORM_RIGHT<"W") echo "disabled" ?> type="submit" name="Updaturlencode($mid)?>";
}
</script>
...
<input <?if ($FORM_RIGHT<"W") echo "disabled" ?> type="button" title="<?echo GetMessage("MAIN_HINT_RESTORE_DEFAULTS")?>" OnClick="RestoreDefa