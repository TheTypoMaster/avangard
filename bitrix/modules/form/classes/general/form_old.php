<?
/*********************************************
	”старевшие функции (дл€ совместимости)
*********************************************/
...
class CForm_old
{
	...
	/*
	выводит HTML формы с учетом прав посетител€

		WEB_FORM_VARNAME - идентификатор формы
		VARS - массив значений дл€ полей ввода
		SHOW_TEMPLATE - им€ шаблона формы
		PREVIEW - если "Y" тогда кнопка "—охранить" в шаблоне недоступна
	*/
	...
	// возвращает hidden пол€ дл€ формировани€ массива 
	// вопросов формы значени€ которых не нужно мен€ть в момент редактировани€ результата
...
class CFormResult_old
{
	...
	/*
	выводит HTML формы редактировани€ результата с учетом прав пользовател€

		RESULT_ID - ID результата
		arrVALUES - массив значений дл€ полей ввода
		TEMPLATE - шаблон дл€ редактировани€ результата
	*/
	...
	/*
	выводит HTML показывающий результат с учетом прав посетител€

		RESULT_ID - ID результата
		TEMPLATE - им€ шаблона дл€ показа результат
		TEMPLATE_TYPE - 
			если "show" тогда беретс€ шаблон дл€ показа,
			если "print" тогда беретс€ шаблон дл€ печати
	*/
