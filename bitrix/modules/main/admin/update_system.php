			...
			if ($arUpdateList)
			{
				...
				if ($newLicenceSigned != "Y")
				{
					...
					function ShowLicence()
					{
						...
						txt += '<iframe name="license_text" src="http://www.1c-bitrix.ru/license-<?=(IsModuleInstalled("intranet")? "intranet-":"")?><?= ((LANGUAGE_ID == "ru") ? "ru" : "en") ?>.htm" style="width:450px; height:250px; display:block;"></iframe>';
						txt += '</td></tr><tr><td>';
		...
		<td colspan="2">
			...
			<table border="0" cellspacing="1" cellpadding="3">
				...
				<tr>
					...
					?>&nbsp;&nbsp;<?echo GetMessage("SUP_CHECK_LIC", array("#LICENSE_KEY#"=>md5($lic)))?></td>
				</tr>
				<?if (array_key_exists("CLIENT", $arUpdateList)):?>
					<tr>
