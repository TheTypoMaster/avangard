	...
	function ChangePermission($MODULE_ID, $arGroups, $ITEM_ID=false, $PARAM1=false, $PARAM2=false, $SITE_ID=false)
	{
		...
		$strSql = "
			...
			(
				...
				".($bIncSites?"AND EXISTS (
					SELECT * FROM b_search_content_site scsite
					WHERE sc.ID=scsite.SEARCH_CONTENT_ID ":"")."
				".$strSqlWhere."
			)";
