...
/********************************************************************
Component "Poll result" (with poll description and with thin border on the form). 

Displays diagrams for the poll results (with poll description and with thin border on the form). Each question has its own result diagram which is being specified in the question settings through the administrative part of the module. This is standard component that is supplied with the module.

Sample of usage:

$APPLICATION->IncludeFile("vote/vote_result/border.php", array(
