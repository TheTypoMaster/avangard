...
<?
for($i=0;$i<216;$i++) # перебираем 216 цетов
{
# Составляющие цвета меняются с разной периодичностью, определяемой делителем.
$t_R=$i%6;
$t_G=floor($i/36)%6;
$t_B=floor($i/6)%6;
...
function quoteMessageEx(theAuthor)
{
	...
	if (selection!="")
	{
		document.getElementById("MESSAGE").value += "[quote]"+theAuthor+" <?echo GetMessage("JQOUTE_AUTHOR_WRITES");?>:\n"+selection+"[/quote]\n";
	}
}
