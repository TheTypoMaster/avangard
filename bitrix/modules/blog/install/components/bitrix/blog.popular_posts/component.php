...
else
{
	...
	if($perms != BLOG_PERMS_DENY)
	{
		...
		while ($arPost = $dbPosts->GetNext())
		{
			...
			$arTmp["AuthorName"] = CBlogUser::GetUserName($arPost["BLOG_USER_ALIAS"], $arPost["AUTHOR_NAME"], $arPost["AUTHOR_LAST_NAME"], $arPost["AUTHOR_LOGIN"], $arPost["AUTHOR_SECOND_NAME"]);
