...
else
{
	...
	if($arResult["bEdit"]=="Y")
	{
		...
		<tr>
			...
			<td nowrap><?=GetMessage("B_B_USER_ALIAS_COM")?></td>
		</tr>
		<tr>
			...
			<td nowrap><?=GetMessage("B_B_USER_ABOUT_COM")?></td>
		</tr>
		<tr>
			...
			<td nowrap><?=GetMessage("B_B_USER_SITE_COM")?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td nowrap><?=GetMessage("B_B_USER_BIRTHDAY_COM")?> (<?=FORMAT_DATE?>).</td>
		</tr>
		<tr>
			<td class="head" nowrap><b><?=GetMessage("B_B_USER_PHOTO")?></b></td>
			<td>
			...
			<td nowrap><?=GetMessage("B_B_USER_PHOTO_COM")?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td nowrap><?=GetMessage("B_B_USER_INTERESTS_COM")?></td>
		</tr>
		<?// ********************* User properties ***************************************************?>
	...
	else
	{
		...
		<tr>
			<td class="head" nowrap><b><?=GetMessage("B_B_FR_FR_OF")?></b></td>
			<td nowrap>
			<?
		...
		<tr>
			<td class="head" nowrap><b><?=GetMessage("B_B_FR_FR")?></b></td>
			<td nowrap>
			<?
