	...
	<div class="blog-mainpage-meta">
		...
		$APPLICATION->IncludeComponent(
			...
			Array(
				...
				"USER_VOTE" => $arResult["RATING"][$arPost["ID"]]["USER_VOTE"],
				"USER_HAS_VOTED" => $arResult["RATING"][$arPost["ID"]]["USER_HAS_VOTED"],
				"TOTAL_VOTES" => $arResult["RATING"][$arPost["ID"]]["TOTAL_VOTES"],
				"TOTAL_POSITIVE_VOTES" => $arResult["RATING"][$arPost["ID"]]["TOTAL_POSITIVE_VOTES"],
				"TOTAL_NEGATIVE_VOTES" => $arResult["RATING"][$arPost["ID"]]["TOTAL_NEGATIVE_VOTES"],
				"TOTAL_VALUE" => $arResult["RATING"][$arPost["ID"]]["TOTAL_VALUE"],
