...
foreach($arResult as $arPost)
{
	...
	<span class="blog-author">
		<a href="<?=$arPost["urlToAuthor"]?>" title="<?=GetMessage("BLOG_BLOG_M_TITLE_BLOG")?>" class="blog-user-grey"></a>&nbsp;<a href="<?=$arPost["urlToBlog"]?>" title="<?=GetMessage("BLOG_BLOG_M_TITLE_BLOG")?>"><?=$arPost["AuthorName"]?></a>
	</span>
	<br clear="left" />
	<span class="blog-post-date"><a href="<?=$arPost["urlToPost"]?>"><?
