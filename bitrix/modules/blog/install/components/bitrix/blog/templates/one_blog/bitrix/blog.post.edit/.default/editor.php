...
BX.ready(function() {	
	BX.addCustomEvent(BX('blog-post-user-fields-UF_BLOG_POST_DOC'), 'OnFileUploadSuccess', function(result, obj){
		if(BX.findChild(BX('POST_BLOG_FORM'), {'attr': {id: 'upload-cid'}}, true, false))
			BX.findChild(BX('POST_BLOG_FORM'), {'attr': {id: 'upload-cid'}}, true, false).value = obj.CID;
