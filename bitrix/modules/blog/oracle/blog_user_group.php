...
class CBlogUserGroup extends CAllBlogUserGroup
{
	...
	function Add($arFields)
	{
		...
		if (strlen($arInsert[0]) > 0)
		{
			$ID = IntVal($DB->NextID("SQ_B_BLOG_USER_GROUP"));

			$strSql =
				"INSERT INTO b_blog_user_group(ID, ".$arInsert[0].") ".
	...
	function Update($ID, $arFields)
	{
		...
		if (strlen($strUpdate) > 0)
		{
			...
			unset($GLOBALS["BLOG_USER_GROUP_CACHE_".$ID]);
...
/*
				"USER_GROUP_ID" => array("FIELD" => "U2UG.ID", "TYPE" => "int", "FROM" => "INNER JOIN b_blog_user2user_group U2UG ON (G.ID = U2UG.USER_GROUP_ID)"),
				"USER_GROUP_USER_ID" => array("FIELD" => "U2UG.USER_ID", "TYPE" => "int", "FROM" => "INNER JOIN b_blog_user2user_group U2UG ON (G.ID = U2UG.USER_GROUP_ID)"),
				"USER_GROUP_BLOG_ID" => array("FIELD" => "U2UG.BLOG_ID", "TYPE" => "int", "FROM" => "INNER JOIN b_blog_user2user_group U2UG ON (G.ID = U2UG.USER_GROUP_ID)"),
*/
		);
		// <-- FIELDS
