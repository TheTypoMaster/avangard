		...
		<td colspan="2" align="center">
			...
			while ($arGroup = $dbGroups->Fetch())
			{
				...
				<tr>
					...
					<td align="center" style="text-align:center;"><input type="checkbox"<?if ($str_PM_VIEW == "Y") echo "checked";?> name="PM_VIEW_<?= $arGroup["ID"] ?>" OnClick="PMOnClick(<?= $arGroup["ID"] ?>)" value="Y"></td>
					<td align="center" style="text-align:center;"><input type="checkbox"<?if ($str_PM_CANCEL == "Y") echo "checked";?> name="PM_CANCEL_<?= $arGroup["ID"] ?>" OnClick="PMOnClick(<?= $arGroup["ID"] ?>)" value="Y"></td>
					<td align="center" style="text-align:center;"><input type="checkbox"<?if ($str_PM_DELIVERY == "Y") echo "checked";?> name="PM_DELIVERY_<?= $arGroup["ID"] ?>" OnClick="PMOnClick(<?= $arGroup["ID"] ?>)" value="Y"></td>
					<td align="center" style="text-align:center;"><input type="checkbox"<?if ($str_PM_PAYMENT == "Y") echo "checked";?> name="PM_PAYMENT_<?= $arGroup["ID"] ?>" OnClick="PMOnClick(<?= $arGroup["ID"] ?>)" value="Y"></td>
					<td align="center" style="text-align:center;"><input type="checkbox"<?if ($str_PM_STATUS == "Y") echo "checked";?> name="PM_STATUS_<?= $arGroup["ID"] ?>" OnClick="PMOnClick(<?= $arGroup["ID"] ?>)" value="Y"></td>
					<td align="center" style="text-align:center;"><input type="checkbox"<?if ($str_PM_STATUS_FROM == "Y") echo "checked";?> name="PM_STATUS_FROM_<?= $arGroup["ID"] ?>" OnClick="PMOnClick(<?= $arGroup["ID"] ?>)" value="Y"></td>
					<td align="center" style="text-align:center;"><input type="checkbox"<?if ($str_PM_UPDATE == "Y") echo "checked";?> name="PM_UPDATE_<?= $arGroup["ID"] ?>" OnClick="PMOnClick(<?= $arGroup["ID"] ?>)" value="Y"></td>
					<td align="center" style="text-align:center;"><input type="checkbox"<?if ($str_PM_DELETE == "Y") echo "checked";?> name="PM_DELETE_<?= $arGroup["ID"] ?>" OnClick="PMOnClick(<?= $arGroup["ID"] ?>)" value="Y"></td>
				</tr>
				<script language="JavaScript">
				<!--
