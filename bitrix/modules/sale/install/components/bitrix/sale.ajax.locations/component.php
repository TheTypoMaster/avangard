...
$countList = $rsLocCount->SelectedRowsCount();
if ($countList <= 0)
...
if (($arParams["COUNTRY"] > 0 || count($arResult["COUNTRY_LIST"]) <= 0) && (strlen($arParams["REGION_INPUT_NAME"]) > 0 || strlen($arParams["ZIPCODE"]) > 0))
{
