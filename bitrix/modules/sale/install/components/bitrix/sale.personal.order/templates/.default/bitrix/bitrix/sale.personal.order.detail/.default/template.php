		...
		<td colspan="2">
			<table class="sale_personal_order_detail data-table">
				...
				<tr>
					...
					<td align="right" colspan="4"><?=$arResult["DISCOUNT_VALUE_FORMATED"]?></td>
				</tr>
				<?
				foreach($arResult["TAX_LIST"] as $val)
				{
					...
					<tr>
						<td align="right"><?
							...
							echo $val["VALUE"];
							?>:</td>
						<td align="right" colspan="4"><?=$val["VALUE_MONEY_FORMATED"]?></td>
					</tr>
					<?
				}
				?>
				<tr>
					...
					<td align="right" colspan="4"><?=$arResult["TAX_VALUE_FORMATED"]?></td>
				</tr>
				<tr>
					<td align="right"><b><?=GetMessage("SPOD_DELIVERY")?>:</b></td>
					<td align="right" colspan="4"><?=$arResult["PRICE_DELIVERY_FORMATED"]?></td>
				</tr>
				<tr>
