...
class CSaleOrder extends CAllSaleOrder
{
	...
	public function AddOrderHistory($OldFields, $NewFields)
	{
		...
		$db_events = GetModuleEvents("sale", "OnBeforeOrderAddHistory");
		while ($arEvent = $db_events->Fetch())
		...
		$arDeleteFields = array("ID", "EMP_CANCELED_ID", "EMP_STATUS_ID", "EMP_ALLOW_DELIVERY_ID", "LOCKED_BY", "DATE_LOCK", "UPDATED_1C", "DATE_INSERT", "DATE_UPDATE", "USER_DESCRIPTION", "ADDITIONAL_INFO", "COMMENTS", "RECOUNT_FLAG", "RECURRING_ID");
		...
		$events = GetModuleEvents("sale", "OnAfterOrderAddHistory");
		while ($arEvent = $events->Fetch())
