...
class CSaleViewedProduct extends CAllSaleViewedProduct
{
	...
	*/
	public function Add($arFields)
	{
		...
		$db_events = GetModuleEvents("sale", "OnBeforeViewedAdd");
		...
		$events = GetModuleEvents("sale", "OnViewedAdd");
	...
	*/
	public function DeleteForUser($FUSER_ID, $LIMIT = NULL)
	{
		...
		$db_events = GetModuleEvents("sale", "OnBeforeViewedDelete");
		while ($arEvent = $db_events->Fetch())
		...
		$db_events = GetModuleEvents("sale", "OnViewedDelete");
		while ($arEvent = $db_events->Fetch())
			if (ExecuteModuleEventEx($arEvent, array($FUSER_ID))===false)
				return false;
