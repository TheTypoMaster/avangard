...
class CALLSaleProduct
{
	 ...
	 * @return array
	 */
	function GetProductSku($USER_ID, $LID, $PRODUCT_ID, $PRODUCT_NAME = '')
	{
...
class CAllSaleViewedProduct
{
	...
	*/
	public function Update($ID, $arFields)
	{
		...
		$db_events = GetModuleEvents("sale", "OnBeforeViewedUpdate");
		...
		$events = GetModuleEvents("sale", "OnViewedUpdate");
