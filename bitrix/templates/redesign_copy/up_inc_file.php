...
<table width="100%" cellspacing="0" cellpadding="0" border="0"> 
  <tbody> 
    ...
    <tr><td> 
		...
		<? echo '<h3 class="divan"><a class="divan_a" href="/redesign/catalog/byid.php?id='.$arElementFields[ID].'" > '.$arElementFields[NAME].'</a></h3><h3 class="collection">Коллекция <strong>'.$arCollection[NAME].'</strong></h3>'.$arElementFields[PREVIEW_TEXT].'</div></td></tr></table></td>';    }?> 
