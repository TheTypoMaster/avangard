	...
	<table class="data-table">
		...
		<tbody>
			...
			if ($propertyID == 114) {
				...
				<tr>
					<td></td>
					<td><input type="checkbox" name="PROPERTY[114][177]" value="177" id="property_177" /> Я ознакомлен и согласен со всеми условиями <a href="/basket/dogovor.php?ajax=Y" id="dogovorishe">договора</a>.</td>
				</tr>
				<?php
			} else {
			?>
