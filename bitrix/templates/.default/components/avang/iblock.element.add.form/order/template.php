...
<link href="/images/jsandcss/ajax.css" type="text/css" rel="stylesheet" /> 
 
<script type="text/javascript" src="/images/jsandcss/ajax.js"></script> 
 
 
<script type="text/javascript" src="http://code.jquery.com/jquery-1.4.2.min.js"></script> 
<script type="text/javascript" src="/images/jsandcss/jquery.mousewheel-3.0.2.pack.js"></script> 
<script type="text/javascript" src="/images/jsandcss/jquery.fancybox-1.3.1.js"></script> 
<link rel="stylesheet" href="/images/jsandcss/jquery.fancybox-1.3.1.css" type="text/css" media="screen" /> 
 
<script type="text/javascript"> 
		$(document).ready(function() {		
			$("#dogovorishe").fancybox()
		});
</script> 
...
<form name="iblock_add" action="<?=POST_FORM_ACTION_URI?>" method="post" enctype="multipart/form-data">
	...
	<table class="data-table">
		...
		<tbody>
			...
			//print_r();
			if ($propertyID=="NAME") { ?>
				<input type="hidden" value="Заказ от <?=date("d.m.Y H:i")?>" name="PROPERTY[NAME][0]"> <?
				continue;
			} 
			if ($propertyID == 114) {
				?>
				<tr>
					<td></td>
					<td><input type="checkbox" name="PROPERTY[114][177]" value="177" id="property_177" /> Я ознакомлен и согласен со всеми условиями <a href="/shop/basket/dogovor.php?ajax=Y" id="dogovorishe">договора</a>.</td>
				</tr>
				<?php
			} else {
			?>
