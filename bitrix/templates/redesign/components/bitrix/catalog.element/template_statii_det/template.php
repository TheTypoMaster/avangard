...
<table cellspacing="0" cellpadding="0" align="left" width="100%"> 
  ...
  <?
	   ...
	   $arElementSelect = Array("ID", "NAME", "DATE_ACTIVE_FROM", "PREVIEW_PICTURE", "PROPERTY_SKIDKA", "PROPERTY_FULLCOLOR_PIC", "PROPERTY_NOVELTY", "PROPERTY_BLACKWHITE_PIC", "PROPERTY_HIT",  "PROPERTY_COLLECTION", "IBLOCK_ID");
	   ...
	   while($obElement = $resElement->GetNextElement())
		...
		?>
				...
				<a href="/catalog/divan<?=$arElementFields[ID]?>.htm"><img onMouseOver="this.src='<?=$img_path?>';" onMouseOut="this.src='<?=$img_path_bl?>';" class="catalog_picture" src="<?=$img_path_bl?>" alt="<?=$arElementFields[NAME]?>"></a><br>
					...
					<br><a href="/8days/orthopedic_furniture.php">Выбрать ортопедический матрас
					<br><img src="/8days/image/orto-1.png" border="0" width="24"><img style="margin-left:5px;" src="/8days/image/orto-2.png" border="0" width="24"><img style="margin-left:5px;" src="/8days/image/orto-3.png" border="0" width="24"><img style="margin-left:5px;" src="/8days/image/orto-4.png" border="0" width="24"></a>
...
<table class="spisok_salonov_sm" cellspacing="0" cellpadding="0" border="0">
	<thead>
	<tr>
		<td width="100"><center>СТ. МЕТРО, ГОРОД</center></td><td  width="40"><center>АКЦИЯ</center></td><td  width="100"><center>САЛОН</center></td><td  width="100"  align="center"><center>АДРЕС</center></td><td  width="70"><center>В НАЛИЧИИ</center></td>
	...
	<tr bgcolor="<?=$bgcol?>">
		<td>
			<? if($arSalon["PROPERTY_SALON_CITY_VALUE"] =='Москва') echo "<img src='/wharetobuy/maps/metro.gif'> ".$arSalon["PROPERTY_SALON_METRO_VALUE"]; else echo $arSalon["PROPERTY_SALON_CITY_VALUE"];  ?>
		</td>
		<td  align="center">
...
if($ob_sub>0){?><a style="text-decoration: none; font-size: 14px; " href="/mebel_sal.php?id=<?=$arSalon["ID"]?>" onClick="showDivans(<?=$arSalon["ID"]?>); return false;"    target="_new"><img style="padding-top: 3px;" src="/images/camera.gif" border="0" alt="Диваны в наличии"> (<?=$ob_sub?>)
</a>
<?}?></center>
		</td>
