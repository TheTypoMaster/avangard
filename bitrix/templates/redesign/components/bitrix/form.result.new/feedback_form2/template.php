...
?>
        ...
        <tfoot>
                <tr>
                        <th colspan="2">
                                <input  type="submit" name="web_form_submit" value="Отправить сообщение" onClick="if (document.forms['SIMPLE_FORM_5'].elements['form_hidden_644'].value=='')document.forms['SIMPLE_FORM_5'].elements['form_hidden_644'].value='advertising@avangard.biz'"/>
