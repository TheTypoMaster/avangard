...
<a href="<?=$ar2["DETAIL_PAGE_URL"]?>"><img border="0" src="<?=$ar2["PREVIEW_PICTURE"]["SRC"]?>" width="<?=$ar2["PREVIEW_PICTURE"]["WIDTH"]?>" height="<?=$ar2["PREVIEW_PICTURE"]["HEIGHT"]?>" alt="<?=$ar2["PREVIEW_PICTURE"]["ALT"]?>" title="<?=$ar2["NAME"]?>" /></a><br />
<?=$ar2["NAME"]?><br />
<? if ($ar2["DISPLAY_PROPERTIES"]["PRICE_NEW"]["VALUE"]) echo $ar2["DISPLAY_PROPERTIES"]["PRICE_NEW"]["VALUE"].'<br />';
   if ($ar2["DISPLAY_PROPERTIES"]["PRICE_OLD"]["VALUE"]) echo $ar2["DISPLAY_PROPERTIES"]["PRICE_OLD"]["VALUE"].'<br />';
?>

<? /*
<?foreach($ar2["DISPLAY_PROPERTIES"] as $pid=>$arProperty):?>
					<?=$arProperty["NAME"]?>:<b>&nbsp;<?
