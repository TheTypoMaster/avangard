...
$arResColl=GetIBlockElement($id_collection);   echo($arResColl["NAME"]); 
 ?>
<a target="_new" href="/mebel_sal.php?all_models=<?=$arResult["ID"]?>"><font style="font-weight:bold; color: #000000; margin-left: 22px;">Модель в наличии</font></a>
</h1>
</div>
...
<table width="100%" align="center" cellspacing="1" cellpadding="4" border="0" bgcolor="#e8e8e8" class="s" >
  <tbody>
    <tr><td height="25" align="center" colspan="7"><b>ГАБАРИТНЫЕ РАЗМЕРЫ</b></td></tr>
    ...
    <td bgcolor="#f8f8f8" align="center"><b>Механизм<br />трансформации</b></td>
    <td bgcolor="#f8f8f8" align="center" style= "border-right: solid #e8e8e8 1px;"><b>Цена</b> от (руб.)</td>
    </tr>
...
?></td>
<? if ($cnt==0) echo '<td bgcolor="#ffffff"  align="center" rowspan="'.count($arResult["PROPERTIES"]["COMPLECT"]["VALUE"]).'" style="border-right: solid #e8e8e8 1px;">'.$arResult["PROPERTIES"]["PRICE"]["VALUE"].'</td>';?>
 </tr>
...
<br />
<p><b><span style="color:#FF0000;">"Цена от"</span> - цена модели в начальной категории ткани при минимальной комплектации
<br />без учета текущих скидок и проводимых акций.</b></p>
