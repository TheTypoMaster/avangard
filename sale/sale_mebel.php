...
Распродажа во всех салонах Москвы и Московской области</h3>
...
<td></td>
<td><input type="radio" disabled name="id" value="<?=$salon?>"></td><td style="color: #cccccc;">В этом салоне</td>
...
foreach ($collections as $key => $value) {
 $c_counter = 0;
  ...
  $html_temp = '';
$res_items = CIBlockElement::GetList($sort, $arFilter, false, Array("nPageSize"=>500), $arSelect);
