...
$APPLICATION->SetPageProperty("title", "Мягкая мебель из наполнителя пенополиуретана (ППУ). Диваны из полиуретана");
$APPLICATION->SetTitle("Мягкая мебель из наполнителя пенополиуретана (ППУ). Диваны из полиуретана");
?> 
