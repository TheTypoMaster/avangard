...
<?
require($_SERVER["DOCUMENT_ROOT"]."/bitrix/header.php");
$APPLICATION->SetPageProperty("title", "Диваны с механизмом трансформации аккордеон. Большой выбор надёжных диванов типа аккордеон с выдвижными спальными ящиками и раскладными пружинными блоками.");
$APPLICATION->SetTitle("Title");
